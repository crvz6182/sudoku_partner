...
// 函数的实现
void QtGuiApplication2::restartButtonCliked()
{
...
void QtGuiApplication2::clearButtonClicked()
{
	for (int i = 0; i < 81; i++)
	{
...
void QtGuiApplication2::submitButtonClicked()
{
	timer->stop();  // 计时器停止
					// 更新最佳纪录
...
void QtGuiApplication2::modeChooseCliked()
{
	// 判断是点击了哪种模式
...
void QtGuiApplication2::hintCliked()
{
	int resultSudo[81];
	int rSudo[81];
	bool result;
...
void QtGuiApplication2::helpClicked()
{
